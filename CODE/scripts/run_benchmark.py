...
def run_benchmark(dataset_name: str = "vietnamese"):
    ...
    if dataset_name == "vietnamese":
        dataset_path = Path("data/evaluation/datasets/vietnamese_sample.json")
    else:
        dataset_path = Path("data/evaluation/datasets/squad_2_0_sample.json")
    ...
    # Save results
    output_dir = Path("data/evaluation/benchmark_results")
